...
<?php $this->start('page')?>
<div id="toolbar">
	<button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalCliente"><i class="fa fa-user-plus"></i>Alta</button>
	<button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalCliente"><i class="fa fa-edit"></i> Editar</button>
	<button type="button" class="btn btn-success" ><i class="fa fa-ticket"></i> Perfil</button>
